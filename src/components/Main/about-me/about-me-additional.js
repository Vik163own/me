      ...
      {isNameAddInfo === 'about-me' && (
        <>
          ...
          <p className='aboutMe__additional-info_type_skills'>
            ...
            - Что у меня есть? Это моя семья, двое детей (старший уже
            самостоятельный) и обязанность сделать так, чтобы они ни в чём не
            нуждались, а также есть желание не стоять на месте и развиваться
            самому.
            <br />
          ...
          <p className='aboutMe__additional-info_type_skills'>
            Основным инструментом являлся Adobe Photoshop, при помощи которого
            можно было получать интересные результаты. Дополнительно занимался
            рекламой - это дизайн логотипов, баннеров, визиток. Здесь применял
            Adobe Illustrator, иногда Corel. Ещё в багаж знаний можно добавить
            работу с Windows - установка и настройка самой ОС, а также программ
            и утилит на ее основе.
          </p>
          <p className='aboutMe__additional-info_type_skills'>
          ...
          <p className='aboutMe__additional-info_type_skills'>
            ...
            Понял, что без курсов не обойтись. <br /> Выбрал веб-разработку от
            Яндекс Практикума.
            <br />
            Учеба сразу затянула и я понял, что это мое!
            <br /> Десять месяцев пролетели как один день. Закончив довольно
            успешно этот курс (одним из первых сдал дипломную работу), решил не
            останавливаться и пройти ещё курс react-разработчик. React
